...
export const ColorPicker = ({ onChange }: ColorPickerProps) => {
  return (
    <div className="flex flex-wrap gap-2 items-center max-w-[164px] pr-2 mr-2 border-r border-neutral-200">
      ...
      <ColorButton onClick={onChange} color={{ r: 255, g: 198, b: 90 }} />
...
export const ColorButton = ({ color, onClick }: ColorButtonProps) => {
  return (
    <button
      className="w-6 h-6 items-center flex justify-center hover:opacity-75 transition cursor-pointer"
      onClick={() => onClick(color)}
    >
      <div
        className="h-6 w-6 border rounded-md border-neutral-300"
        style={{
